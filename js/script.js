...
$(document).ready(function() {
      ...
      $('#description').html('check availability for the popular tlds like come,net, org and country specific tlds. laso suggests names separatedby hyphens...');
});
...
function ReadMore (_jObj, lineNum) { //class
  ...
  jObj.append ("<p class=readmore>"+READ_MORE_LABEL+"</p>");
  ...
  jObj.children(".readmore").click ( function() {
	  
    if (jObj.children(".text").css("height") == textMinHeight) {
		
      jObj.children(".text").css("height", ""+textMaxHeight);
      jObj.children(".readmore").html(HIDE_LABEL);
	 
    } else {
	
      jObj.children(".text").css("height", ""+textMinHeight);
      jObj.children(".readmore").html(READ_MORE_LABEL);
